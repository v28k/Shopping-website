...
const handlePaymentSuccess = async (details) => {
    try {
        ...
        //  Only call `/finalize` after confirming `/pay` was successful
    
            await handleFinalizeCheckout(checkoutId);  // Finalize only after payment is confirmed
    } catch (error) {
        ...
        <form onSubmit={handleCreateCheckout}>
            ...
            <div className="mt-6">
                {!checkoutId ? (
                    ...
                    <div>
                    <h3 className="text-lg mb-4">Proceed to Payment</h3>
                   <RazorpayButton 
