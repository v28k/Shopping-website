...
// @route POST/api/cart
// @desc Add a product to the cart for a guest or logged in use
// @access Public
...
// @route PUT/api/cart
// @desc update product quantity in the cart for a guest or logged in use
// @access public
        ...
        const productIndex = cart.products.findIndex(
            ...
            if(productIndex > -1) {
                ...
                if (quantity > 0 ) {
                    ...
                    cart.products.splice(productIndex, 1);  // remove the product with the quantity zero
                }
...
router.post("/merge", protect, async (req, res) => {
    ...
    try {
        ...
        if (guestCart) {
            ...
            if (userCart) {
                ...
                if (productIndex > -1 ) {
                    ...
                    // otherise, add the guest item to the cart
        ...
        if (userCart) {
            // Guest cart has already been merged, return the use cart
